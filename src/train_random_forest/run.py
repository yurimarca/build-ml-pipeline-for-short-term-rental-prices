...
def go(args):
    ...
    # Save train and validation artifact path in trainval_local_path
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        mlflow.sklearn.save_model(
            ...
            signature=sig, # infer signature
            input_example=X_val[processed_features].iloc[:2] # the first few examples
        )
